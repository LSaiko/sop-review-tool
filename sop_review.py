...
Usage:
    ...
    python sop_review.py --file orthonav_sop.pdf  --sop-type inspection --device-class III
"""
...
def generate_pdf_report(
    ...
    story.append(
        Paragraph(
            "Generated by Claude claude-opus-4-8 | Anthropic API | "
...
Examples:
  ...
  python sop_review.py --file acme_orthonav_sop.pdf --sop-type inspection --device-class III --output orthonav_report.pdf
...
def main() -> None:
    ...
    print(
        f"[2/4] Sending to Claude (model: claude-opus-4-8) "
